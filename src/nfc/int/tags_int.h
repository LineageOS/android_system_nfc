...
extern const uint8_t t4t_v10_ndef_tag_aid[];  /* V1.0 Type 4 Tag Applicaiton ID */
extern const uint8_t t4t_v20_ndef_tag_aid[];  /* V2.0 Type 4 Tag Applicaiton ID */
...
extern const tT2T_INIT_TAG * t2t_tag_init_data (uint8_t manufacturer_id, bool    b_valid_ver, uint16_t version_no);
