...
void LogMsg_2 (uint32_t trace_set_mask, const char *fmt_str, uintptr_t p1, uintptr_t p2);
void LogMsg_3 (uint32_t trace_set_mask, const char *fmt_str, uintptr_t p1, uintptr_t p2, uintptr_t p3);
void LogMsg_4 (uint32_t trace_set_mask, const char *fmt_str, uintptr_t p1, uintptr_t p2, uintptr_t p3, uintptr_t p4);
void LogMsg_5 (uint32_t trace_set_mask, const char *fmt_str, uintptr_t p1, uintptr_t p2, uintptr_t p3, uintptr_t p4, uintptr_t p5);
void LogMsg_6 (uint32_t trace_set_mask, const char *fmt_str, uintptr_t p1, uintptr_t p2, uintptr_t p3, uintptr_t p4, uintptr_t p5, uintptr_t p6);
